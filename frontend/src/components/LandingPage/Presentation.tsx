const Presentation = () => {
	return (
		<section className="w-full bg-white text-center px-4 pt-16 pb-16 rounded-t-3xl -mt-8 relative z-20">
			...
			<div className="flex flex-col md:flex-row justify-center items-center gap-8 max-w-6xl mx-auto">
				<div className="bg-white shadow-md p-6 rounded-lg max-w-xs">
					<div className="w-20 h-20 bg-gray-200 mx-auto mb-4 rounded-full"></div>
					...
					<p className="text-gray-600">
						...
						événements les plus proches en temps réel.
					</p>
				</div>
